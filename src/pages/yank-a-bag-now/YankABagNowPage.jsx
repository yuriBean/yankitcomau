              ...
              <Card className="max-w-3xl mx-auto shadow-xl glassmorphism border-none dark:bg-slate-800/50">
                <CardHeader>
                  <CardTitle className="text-xl text-foreground dark:text-white flex items-center">
                    ...
                    Enter Your Trip & Bag Details to Earn on Your Flight
                  </CardTitle>
                ...
                <form onSubmit={handleFormSubmit}>
                  ...
                  <CardFooter className="flex flex-col items-stretch gap-4">
                    ...
                    >
                      {isLoading || pageLoading || isCalculationPending ? <Loader2 className="h-5 w-5 animate-spin mr-2" /> : <DollarSign className="mr-2 h-5 w-5" />}
                      {isLoading || pageLoading ? 'Processing...' : (isCalculationPending ? 'Calculating...' : 'List Your Space')}
                    </Button>
                    {!session && !pageLoading && (
